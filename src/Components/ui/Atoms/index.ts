...
import AccountCreatedIllustrations from './IconAtom/Illustrations/AccountCreatedIllustrations';

export {BoxAtom} from './BoxAtom';
export {ButtonAtom} from './ButtonAtom';
export {InputAtom} from './InputAtom';
export {TextAtom} from './TextAtom';
export {IconAtom, IconWrapperAtom, IconButtonAtom} from './IconAtom';
